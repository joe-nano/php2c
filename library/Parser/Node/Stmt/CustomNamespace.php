...
/**
 * @property null|Name $name  Name
 * @property Node[]         $stmts Statements
 */
class CustomNamespace extends Stmt
{
     ...
     *
     * @param null|Name $name       Name
     * @param Node[]         $stmts      Statements
     * @param array                    $attributes Additional attributes
     */
    public function __construct(Name $name = null, $stmts = array(), array $attributes = array()) {
        parent::__construct(
            array(
                'name'  => $name,
                'stmts' => $stmts,
